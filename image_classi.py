...
def get_training_data():
    ...
    data_dir_path = '/Users/tanmesh/dev/traffic/dataset'
    img_data_list = []
    labels = []
...
def classify_vehicle():
    ...
    # negative scenario
    test_image_path = '/Users/tanmesh/dev/traffic/dataset/vehicles_test/4593_not_vehicle.jpg'
    test_model(model, test_image_path)

    # positive scenario
    test_image_path = '/Users/tanmesh/dev/traffic/dataset/vehicles_train/02033_vehicle.jpg'
    test_model(model, test_image_path)
